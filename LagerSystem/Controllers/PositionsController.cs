...
namespace LagerSystem.Views
{
    public class PositionsController : Controller
    {
        ...
        {
            var storageContext = _context.Positions.Include(p => p.Pallet);
        ...
        public async Task<IActionResult> Create([Bind("Id,Available,PalletId,RackId,Height,Width,RackPosition")] Position position)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Available,PalletId,RackId,Height,Width,RackPosition")] Position position, Pallet pallet)
        {
            if (id != position.Id)
            {
                return NotFound();
